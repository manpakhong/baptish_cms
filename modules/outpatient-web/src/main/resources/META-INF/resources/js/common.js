...
var systemMessageWindow = (function () {
    ...
    function _change(systemMessageType, message){
        ...
        if (systemMessageType == SYSTEM_MESSAGE_DIALOG_ERROR){
        		$(systemMessageWindowTitleImage).attr('src', CONTEXT_PATH + '/image/if_Error_16.png');
        		$(systemMessageWindowContentImage).attr('src', CONTEXT_PATH + '/image/if_Error_32.png');
        		$(systemMessageSpan).text('System Error');
        } else if (systemMessageType == SYSTEM_MESSAGE_DIALOG_WARNING){
			$(systemMessageWindowTitleImage).attr('src', CONTEXT_PATH + '/image/if_Warning_16.png');
			$(systemMessageWindowContentImage).attr('src', CONTEXT_PATH + '/image/if_Warning_32.png');
			$(systemMessageSpan).text('System Warning');
        } else if (systemMessageType == SYSTEM_MESSAGE_DIALOG_INFO){
        		$(systemMessageWindowTitleImage).attr('src', CONTEXT_PATH + '/image/if_Info_16.png');
        		$(systemMessageWindowContentImage).attr('src', CONTEXT_PATH + '/image/if_Info_32.png');
...
var CommonFunction = {
	...
	$(document).ready(function () {
        try{
        	...
        	var systemMessage = "9000 - System Error!";
        	systemMessageWindow.init(SYSTEM_MESSAGE_DIALOG_ERROR, systemMessage);
