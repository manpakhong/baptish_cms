...
/**
 * Provides the local service interface for Code. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Dave Man
 * @see CodeLocalServiceUtil
...
public interface CodeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CodeLocalServiceUtil} to access the code local service. Add custom service methods to {@link hk.org.hkbh.cms.outpatient.service.impl.CodeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
