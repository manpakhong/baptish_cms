...
/**
 * Provides the local service interface for ComponentControl. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Dave Man
 * @see ComponentControlLocalServiceUtil
...
public interface ComponentControlLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ComponentControlLocalServiceUtil} to access the component control local service. Add custom service methods to {@link hk.org.hkbh.cms.outpatient.service.impl.ComponentControlLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ComponentControl addComponentControl(
	...
	*/
	public ComponentControl createComponentControl(long id);
	...
	*/
	...
	public ComponentControl deleteComponentControl(
		ComponentControl componentControl);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ComponentControl deleteComponentControl(long id)
	...
	*/
	...
	public ComponentControl fetchComponentControl(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ComponentControl> getComponentControls(int start, int end);
