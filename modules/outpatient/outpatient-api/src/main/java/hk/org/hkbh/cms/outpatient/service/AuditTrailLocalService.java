...
/**
 * Provides the local service interface for AuditTrail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Dave Man
 * @see AuditTrailLocalServiceUtil
...
public interface AuditTrailLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AuditTrailLocalServiceUtil} to access the audit trail local service. Add custom service methods to {@link hk.org.hkbh.cms.outpatient.service.impl.AuditTrailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AuditTrail deleteAuditTrail(long id) throws PortalException;
	...
	*/
	...
	public AuditTrail fetchAuditTrail(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AuditTrail getAuditTrail(long id) throws PortalException;
