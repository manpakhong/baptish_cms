...
/**
 * Provides the local service interface for CodeDto. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Dave Man
 * @see CodeDtoLocalServiceUtil
...
public interface CodeDtoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CodeDtoLocalServiceUtil} to access the code dto local service. Add custom service methods to {@link hk.org.hkbh.cms.outpatient.service.impl.CodeDtoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
