 ...
 */
@ProviderType
public class ImagingResultSoap implements Serializable {
	public static ImagingResultSoap toSoapModel(ImagingResult model) {
		ImagingResultSoap soapModel = new ImagingResultSoap();
	...
	public static ImagingResultSoap[] toSoapModels(ImagingResult[] models) {
		ImagingResultSoap[] soapModels = new ImagingResultSoap[models.length];
	...
	public static ImagingResultSoap[][] toSoapModels(ImagingResult[][] models) {
		ImagingResultSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new ImagingResultSoap[models.length][models[0].length];
		}
		else {
			soapModels = new ImagingResultSoap[0][0];
		}
	...
	public static ImagingResultSoap[] toSoapModels(List<ImagingResult> models) {
		List<ImagingResultSoap> soapModels = new ArrayList<ImagingResultSoap>(models.size());

		for (ImagingResult model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new ImagingResultSoap[soapModels.size()]);
	}

	public ImagingResultSoap() {
	}
