...
/**
 * Provides the base implementation for the component control local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link hk.org.hkbh.cms.outpatient.service.impl.ComponentControlLocalServiceImpl}.
 * </p>
 *
 * @author Dave Man
 ...
 */
@ProviderType
public abstract class ComponentControlLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ComponentControlLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link hk.org.hkbh.cms.outpatient.service.ComponentControlLocalServiceUtil} to access the component control local service.
	 */
	...
	public ComponentControl createComponentControl(long id) {
		return componentControlPersistence.create(id);
	}
	...
	public ComponentControl deleteComponentControl(long id)
		...
		return componentControlPersistence.remove(id);
	}
	...
	public ComponentControl deleteComponentControl(
		ComponentControl componentControl) {
		return componentControlPersistence.remove(componentControl);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ComponentControl.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return componentControlPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return componentControlPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ComponentControl fetchComponentControl(long id) {
		return componentControlPersistence.fetchByPrimaryKey(id);
	}
	...
	public ComponentControl getComponentControl(long id)
		throws PortalException {
		return componentControlPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(componentControlLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ComponentControl.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(componentControlLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ComponentControl.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return componentControlLocalService.deleteComponentControl((ComponentControl)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return componentControlPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ComponentControl> getComponentControls(int start, int end) {
		return componentControlPersistence.findAll(start, end);
	}
	...
	public int getComponentControlsCount() {
		return componentControlPersistence.countAll();
	}
	 ...
	 */
	public ComponentControlLocalService getComponentControlLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("hk.org.hkbh.cms.outpatient.model.ComponentControl",
			componentControlLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"hk.org.hkbh.cms.outpatient.model.ComponentControl");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ComponentControlLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = componentControlPersistence.getDataSource();
	...
	@BeanReference(type = ComponentControlLocalService.class)
	protected ComponentControlLocalService componentControlLocalService;
