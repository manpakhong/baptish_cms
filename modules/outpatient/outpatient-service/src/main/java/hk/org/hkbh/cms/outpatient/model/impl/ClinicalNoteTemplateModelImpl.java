...
/**
 * The base model implementation for the ClinicalNoteTemplate service. Represents a row in the &quot;cms.clinical_note_template&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ClinicalNoteTemplateModelImpl extends BaseModelImpl<ClinicalNoteTemplate>
	 ...
	 */
	public static final String TABLE_NAME = "cms.clinical_note_template";
	...
	public static final String TABLE_SQL_CREATE = "create table cms.clinical_note_template (id_ INTEGER not null primary key,userId INTEGER,templateTypeCodeId INTEGER,templateName VARCHAR(75) null,templateContent VARCHAR(75) null,templateContentHtml VARCHAR(75) null,createDate DATE null,updateDate DATE null,createdBy VARCHAR(75) null,updatedBy VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table cms.clinical_note_template";
	public static final String ORDER_BY_JPQL = " ORDER BY clinicalNoteTemplate.id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY cms.clinical_note_template.id_ ASC";
